        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT medicalreports.Id, medicalreports.note, users.Fullname AS Fullname, medicalreports.patient, medicalreports.file FROM medicalreports JOIN users ON medicalreports.patient = users.Id";
