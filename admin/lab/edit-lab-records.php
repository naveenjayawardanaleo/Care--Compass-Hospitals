...
<?php 
    ...
    $sql = "SELECT Id, note, patient, file FROM medicalreports WHERE Id=$reportnumber";
    ...
    <div class="container-fluid ">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <form action="edit-medical-test-process.php" method="post" enctype="multipart/form-data">
                                ...
                                // output data of each row
                                    while($rowz = $result->fetch_assoc()) {
                                        ...
                                        echo '
                                         ...
                                         echo 'value="' . $rowz['Id'] . '">' . $rowz['Fullname'] . '</option>'    
